...
import sty from "./PlasmicBlogPost.module.css"; // plasmic-import: q_LjUx71MsqHbO/css
  ...
  return (
    ...
    >
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__hFlVa, {
            [sty.freeBoxlong__hFlVaTxN1V]: hasVariant($state, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__aUrrN)}
                displayHeight={"auto"}
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__czNiF, {
          [sty.freeBoxlong__czNiFTxN1V]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
