...
import sty from "./PlasmicMenuButton.module.css"; // plasmic-import: Qab3DN1TM8pM2X/css
import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: 4cUDx6t1ba6Cky/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: jYgM12wOL7_eQp/icon
    ...
    >
      ...
      >
        {(hasVariant($state, "expanded", "expanded") ? true : true) ? (
          <BarsIcon
            className={classNames(projectcss.all, sty.svg__cH0T6, {
              [sty.svgexpanded__cH0T6UrRa]: hasVariant(
                $state,
                "expanded",
                "expanded"
              )
        ...
        {(hasVariant($state, "expanded", "expanded") ? true : true) ? (
          <TimesIcon
            className={classNames(projectcss.all, sty.svg__uCb53, {
              [sty.svgexpanded__uCb53UrRa]: hasVariant(
                $state,
                "expanded",
                "expanded"
              )
