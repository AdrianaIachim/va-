...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: nxrvER4spJg/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: qQguRLvx148/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__u5Sc)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__lca50)}
                role={"img"}
              />
            ),
