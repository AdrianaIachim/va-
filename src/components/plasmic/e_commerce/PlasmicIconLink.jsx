...
import sty from "./PlasmicIconLink.module.css"; // plasmic-import: mdlB7opZfCK7nb/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__ji1G5)}
              role={"img"}
            />
          ),
