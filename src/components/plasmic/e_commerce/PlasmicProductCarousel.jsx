...
import CircleOIcon from "./icons/PlasmicIcon__CircleO"; // plasmic-import: YLda7Na_DpiHV5/icon
...
function PlasmicProductCarousel__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__xRbd)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__blAlQ, {
            [sty.freeBoxslider_second__blAlQl5LjN]: hasVariant(
              $state,
              "slider",
              "second"
            )
        ...
        >
          ...
          <div
            className={classNames(
              ...
              sty.text__uiML,
              {
                [sty.textslider_first__uiML7YFtp]: hasVariant(
                  $state,
                  "slider",
                  "first"
                ),

                [sty.textslider_second__uiMLl5LjN]: hasVariant(
                  $state,
                  "slider",
                  "second"
                ),

                [sty.textslider_third__uiML0I3Nl]: hasVariant(
                  $state,
                  "slider",
                  "third"
                )
          ...
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__lUd1)}
          >
            <LinkButton
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__z9Ux0)}
      >
        <p.PlasmicIcon
          PlasmicIconType={
            hasVariant($state, "slider", "third")
          ...
          className={classNames(projectcss.all, sty.svg__ff07I, {
            [sty.svgslider_second__ff07Il5LjN]: hasVariant(
              $state,
              "slider",
              "second"
            ),

            [sty.svgslider_third__ff07I0I3Nl]: hasVariant(
              $state,
              "slider",
              "third"
            )
        ...
        <p.PlasmicIcon
          ...
          className={classNames(projectcss.all, sty.svg___7WDkm, {
            [sty.svgslider_first___7WDkm7YFtp]: hasVariant(
              $state,
              "slider",
              "first"
            ),

            [sty.svgslider_second___7WDkml5LjN]: hasVariant(
              $state,
              "slider",
              "second"
            ),

            [sty.svgslider_third___7WDkm0I3Nl]: hasVariant(
              $state,
              "slider",
              "third"
            )
        ...
        <p.PlasmicIcon
          ...
          className={classNames(projectcss.all, sty.svg__rHmM2, {
            [sty.svgslider_third__rHmM20I3Nl]: hasVariant(
              $state,
              "slider",
              "third"
            )
